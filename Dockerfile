...
COPY trend_app_protect.properties /usr/local/tomcat/trend_app_protect.properties
ENV export CATALINA_OPTS="\${CATALINA_OPTS} -javaagent:/usr/local/tomcat/trend_app_protect-4.2.0.jar -Dcom.trend.app_protect.config.file=/usr/local/tomcat/trend_app_protect.properties"
